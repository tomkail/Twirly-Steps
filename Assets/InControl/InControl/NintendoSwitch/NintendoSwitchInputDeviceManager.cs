...
namespace InControl
{
	...
	public class NintendoSwitchInputDeviceManager : InputDeviceManager
	{
		...
		public NintendoSwitchInputDeviceManager()
		{
			...
			// JoyRight = Right Joy-Con used by itself.
			...
			// Don't create eight unless you really need them, for performance reasons.
		...
		public static ControllerSupportResultInfo ShowControllerApplet( bool suspendUnityThreads )
		{
		...
		public static ControllerSupportResultInfo ShowControllerApplet( ControllerSupportArg controllerSupportArg, bool suspendUnityThreads )
		{
		...
		public static NpadId ShowControllerSupportForSinglePlayer( bool suspendUnityThreads )
		{
			var controllerSupportArg = new ControllerSupportArg();
			controllerSupportArg.SetDefault();
		...
		public static int ShowControllerSupportForMultiPlayer( byte playerCountMin, byte playerCountMax, bool suspendUnityThreads )
		{
			var controllerSupportArg = new ControllerSupportArg();
			controllerSupportArg.SetDefault();
